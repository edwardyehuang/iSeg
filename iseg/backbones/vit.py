...
class VisionTransformer (tf.keras.Model):
    ...
    def build(self, input_shape):
        ...
        self.patch_encoder = tf.keras.layers.Conv2D(filters = self.filters, 
        ...
        for i in range(self.num_layer):
            self.blocks += [TransformerBlock(self.mlp_filters, 
...
class TransformerBlock (tf.keras.Model):
    ...
    def build(self, input_shape):
        ...
        self.attention = tf.keras.layers.MultiHeadAttention(num_heads = self.num_head, 
                                                            key_dim = channels, 
...
class MLPBlock (tf.keras.Model):
    ...
    def build(self, input_shape):
        ...
        self.dense0 = tf.keras.layers.Dense(self.filters, 
