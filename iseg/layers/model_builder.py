...
class ConvBnRelu(tf.keras.Model):
    def __init__(self, filters = 256,
        ...
        super(ConvBnRelu, self).__init__(trainable = trainable, 
                                         name = name if name is not None else "ConvBnRelu")
...
class LnConvGelu (tf.keras.Model):
    ...
    def __init__(self, filters = 256,
        ...
        self.ln = None if not use_ln else tf.keras.layers.LayerNormalization(trainable = trainable, 
