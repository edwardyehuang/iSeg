...
class CoreTrain (object):
    ...
    def __init__(self, model_helper, train_dataset, val_dataset = None,
                                                    val_image_count = 0,
                                                    use_tpu = False):
    ...
    def create_trainable_model (self, num_class, ignore_label = 255, 
                                                 batch_size = 1,
                                                 epoch_steps = 1000,
                                                 initial_epoch = 0):
        ...
        losses = losses_func(num_class = num_class, 
    ...
    def train (self, distribute_strategy, 
                     num_class = 21,
                     ignore_label = 255,
                     batch_size = 1,
        ...
        with distribute_strategy.scope():
            model = self.create_trainable_model(num_class, ignore_label = ignore_label,
                                                           batch_size = batch_size,
        ...
        model.fit(train_ds, epochs = train_epoches,
    ...
    def __get_default_metrics(self, num_class, ignore_label):
        ...
        iou_metrics = SegMetricWrapper(iou_metrics, 
                                       num_class = num_class, 
                                       ignore_label = ignore_label, 
                                       name = "IOU")
