...
class Block(tf.keras.Model):
    ...
    def __init__(self, activation = tf.nn.swish,
                       drop_rate = 0,
                       filters_in = 32,
                       filters_out = 16,
                       kernel_size = 3,
        ...
        if expand_ratio != 1:
            self.expand_conv = tf.keras.layers.Conv2D(filters = filters, 
                                                      kernel_size = 1, 
                                                      padding = "same",
                                                      use_bias = False,
        ...
        self.dwconv = tf.keras.layers.DepthwiseConv2D(kernel_size = kernel_size,
                                                      strides = strides,
                                                      padding = conv_pad,
                                                      use_bias = False,
        ...
        self.project_conv = tf.keras.layers.Conv2D(filters = filters_out,
                                                   kernel_size = 1,
                                                   padding = "same",
                                                   use_bias = False,
                                                   kernel_initializer = CONV_KERNEL_INITIALIZER,
...
class EfficientNet(tf.keras.Model):
    ...
    def __init__(self, width_confficient,
                       depth_confficient,
...
def EfficientNetB0(return_endpoints = False):
    ...
    return EfficientNet(width_confficient = 1.0,
...
def EfficientNetB2(return_endpoints = False):
    ...
    return EfficientNet(width_confficient = 1.1,
...
def EfficientNetB3(return_endpoints = False):
    ...
    return EfficientNet(width_confficient = 1.2,
...
def EfficientNetB4(return_endpoints = False):
    ...
    return EfficientNet(width_confficient = 1.4,
...
def EfficientNetB5(return_endpoints = False):
    ...
    return EfficientNet(width_confficient = 1.6,
...
def EfficientNetB6(return_endpoints = False):
    ...
    return EfficientNet(width_confficient = 1.8,
...
def EfficientNetB7(return_endpoints = False):
    ...
    return EfficientNet(width_confficient = 2.0,
